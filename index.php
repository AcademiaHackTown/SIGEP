...
<html lang="pt-br">
<head>
	<title>SIGEP - Página Inicial</title>
	<meta charset="UTF-8"/>
...
<?php
	...
	?>
	<ul>
		<li><a class="ativa" href="#"><img src="_icones/icon_home.png" alt="Inicio"> inicio</a></li>
...
<div id="or"><a href="#">inicio</a></div>
<section id="conteudo">
	<article id="submenu">
		<ul id="dist">
			<li dest="acesso">acesso<br><img src="_icones/icon_entrar.png" alt="alunos"><span>usuário cadastrado</span></li>
			<li dest="cadastro">cadastrar<br><img src="_icones/icon_cadastro.png" alt="alunos"><span>usuário não cadastro</span></li>			
		</ul>
	</article>	
</section>
<footer>
	<img src="_imagens/cnpq.jpg" alt="CNPq">	<img src="_imagens/if.jpg" alt="IF Sertao-PE">
</footer>
</div>
</body>
</html>