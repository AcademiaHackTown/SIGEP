<?php
	...
	if(!isset($_SESSION['login']) || $_SESSION['tipo'] != 6){
		setcookie("redirect","material/atividades.php", time() + (86400 * 30), "/");
...
<div id="or"><a href="../selectproj.php">selecionar projeto</a><a href="../">inicio</a><a href="../material">material</a><span>atividades</span><a href="../material" class="voltar">voltar</a></div>
<section id="conteudo">
	<h1 class="titulo">Atividades</h1>
	<article id="lista_th">
		<?php
		require_once("../../_includes/conexao.php");
		$sql = "SELECT ARARQCHA FROM arquivos WHERE ARTPINT = 1 AND ARPRFINT = ".$_SESSION["projeto"]."";
		$q = $myssql->query($sql);
		...
		<?php
			...
			echo "<p>Nenhuma atividade disponivel.</p>";
		}
		?>
	</article>	
