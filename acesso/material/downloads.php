<?php
	...
	if(!isset($_SESSION['login']) || $_SESSION['tipo'] != 6){
		setcookie("redirect","material/downloads.php", time() + (86400 * 30), "/");
...
<div id="or"><a href="../selectproj.php">selecionar projeto</a><a href="../">inicio</a><a href="../material">material</a><span>downloads</span><a href="../material" class="voltar">voltar</a></div>
<section id="conteudo">
	<h1 class="titulo">Downloads</h1>
	<article id="lista_th">
		<p>A lista de arquivos para downloads. Clique sobre para baixar.</p>
		<?php
		require_once("../../_includes/conexao.php");
		$sql = "SELECT ARARQCHA FROM arquivos WHERE ARTPINT = 3 AND ARPRFINT = ".$_SESSION["projeto"]."";
		$q = $myssql->query($sql);
		...
		<ul>
			...
			?>			
			<a href="../../_arquivos/<?php echo $x->ARARQCHA; ?>" target="_blank"><li>&#10154; <?php echo $x->ARARQCHA; ?></li></a>
			<?php
			}
			?>
		</ul>
		<?php
			...
			echo "<p>Nenhum outro arquivo disponivel.</p>";
		}
		?>
	</article>	
