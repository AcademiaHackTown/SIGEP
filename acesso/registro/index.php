...
<html lang="pt-br">
<head>
	<title>SIGEP - Registro de Atividades Diárias</title>
	<meta charset="utf-8"/>
...
<div id="or"><a href="../selectproj.php">selecionar projeto</a><a href="../bolsistas">inicio</a><span>registro de atividades</span><a href="../bolsistas" class="voltar">voltar</a></div>
<section id="conteudo">
	<h3 class="titulo">Área do Bolsista</h3>
	<?php
	...
	<article>
		<form method="post" action="do.php">
			<fieldset><legend>Registro de atividades</legend>
				<label for="i_data">Data:</label><input type="date" name="data" id="i_data" required="required"/>                
				<br><label for="i_cont">O que foi feito:</label><input style="width:400px;" type="text" name="cont" id="i_cont" maxlength="80"/>
                <br><label for="i_detalhes">Detalhes (opcional):</label><textarea name="detalhes" id="i_detalhes" cols="100" rows="20"></textarea>
			</fieldset>
