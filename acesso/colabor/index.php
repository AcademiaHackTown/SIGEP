<?php
	session_start();
	if(!isset($_SESSION['login']) || $_SESSION['tipo'] != 2){
		setcookie("redirect","colabor", time() + (86400 * 30), "/");
		setcookie("redirectTipo",2, time() + (86400 * 30), "/");
		header("Location:../");
	}
...
<head>
	...
	<script type="text/javascript" href="../_javascript/jquery-1.11.3.js"></script>
	<script type="text/javascript" href="../_javascript/funcoes.js"></script>
</head>
<body>
<div id="bck"></div>
<div id="interface">
...
<div id="or"><a href="../selectproj.php">selecionar projeto</a><a href="../">inicio</a><span>acesso</span><a href="../selectproj.php" class="voltar">voltar</a></div>
<section id="conteudo">
	<article id="submenu">
