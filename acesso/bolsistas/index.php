...
<section id="conteudo">
	...
	<article id="submenu">
		<ul id="itens">
			<li dest="../atividades">Tarefas<br><img src="../../_icones/icon_atividades.png" alt="Atividades"><span>acesso às tarefass</span></li>
			<li dest="../arquivos">Upload de Arquivos<br><img src="../../_icones/icon_upload.png" alt="Atividades"><span>outros</span></li>
			<li dest="../registro">Registro de atividades<br><img src="../../_icones/icon_registroAtividades.png" alt="Atividades"><span>preencher<span></li>
            <li dest="../registro/visualizar.php">Registro de atividades<br><img src="../../_icones/icon_registroAtividades.png" alt="Atividades"><span style="color: #09F;">visualizar<span></li>
		</ul>
	</article>	
