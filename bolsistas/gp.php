...
<div id="or"><a href="../acesso/selectproj.php">selecionar projeto</a><a href="../acesso">inicio</a><a href="../bolsistas">bolsistas</a><span>integrantes</span><a href="../bolsistas" class="voltar">voltar</a></div>
<section id="conteudo">
	<article id="submenu">
		<ul>
			<li dest="addm.php">Novo<br><img src="../_icones/icon_addintegrante.png" alt="adicionar pessoa"/><span>adicionar pessoa</span></li>
			<li dest="integrantes.php">Todos<br><img src="../_icones/icon_todosintegrantes.png" alt="visualizar todos os integrantes"/><span>visualizar todos</span></li>			
			<li dest="editarfuncao.php">Editar função<br><img src="../_icones/icon_editarfuncao.png" alt="editar função dos integrantes"/><span>editar função de membro</span></li>			
		</ul>
	</article>	
