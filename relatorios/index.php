<?php
session_start();
if(!isset($_SESSION["login"]) || ($_SESSION["tipo"] != 1 && $_SESSION["tipo"] != 5)) {
    setcookie("redirect","../relatorios");
    setcookie("redirectTipo",1);
...
<div id="or"><a href="../">inicio</a><span>relatorios</span><a href="../" class="voltar">voltar</a></div>
<section id="conteudo">
    <article id="submenu">
        <h2 class="titulo">Relatorios</h2>
